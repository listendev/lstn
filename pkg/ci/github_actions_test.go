...
func TestNewInfoFromGitHubEvent_PushEvent(t *testing.T) {
...
func TestNewInfoFromGitHubEvent_PullRequestEvent(t *testing.T) {
	closer := internaltesting.EnvSetter(map[string]string{
...
func TestNewInfoFromGitHubEvent_ReRunEvent(t *testing.T) {
	closer := internaltesting.EnvSetter(map[string]string{
