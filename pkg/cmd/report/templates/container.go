...
:tada: **lstn** did not detect any malicious behaviors in the dependency tree at installation time :tada:
{{ else }}
:bangbang: **lstn** detected the following behaviors in the dependency tree at installation time :bangbang:
