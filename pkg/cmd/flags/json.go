...
type JSONFlags struct {
	...
	JQ   string `desc:"filter the output verdicts using a jq expression (requires --json)" flag:"jq"   flagset:"Filtering" json:"jq"   name:"jq" shorthand:"q" validate:"excluded_without=JSON,jq"`
}
