...
func TestOptionsGotConfigDefaultsFromEnv(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, 285, rootOpts.ConfigFlags.Reporter.GitHub.Pull.ID)
	assert.Equal(t, "reviewdog", rootOpts.ConfigFlags.Reporter.GitHub.Owner)
	assert.Equal(t, "reviewdog", rootOpts.ConfigFlags.Reporter.GitHub.Repo)
	...
	inOpts, err := NewIn()
	assert.Nil(t, err)
	assert.Equal(t, 285, inOpts.ConfigFlags.Reporter.GitHub.Pull.ID)
	assert.Equal(t, "reviewdog", inOpts.ConfigFlags.Reporter.GitHub.Owner)
	assert.Equal(t, "reviewdog", inOpts.ConfigFlags.Reporter.GitHub.Repo)
	...
	assert.Nil(t, err)
	assert.Equal(t, 285, scanOpts.ConfigFlags.Reporter.GitHub.Pull.ID)
	assert.Equal(t, "reviewdog", scanOpts.ConfigFlags.Reporter.GitHub.Owner)
	assert.Equal(t, "reviewdog", scanOpts.ConfigFlags.Reporter.GitHub.Repo)
	...
	toOpts, err := NewTo()
	assert.Nil(t, err)
	assert.Equal(t, 285, toOpts.ConfigFlags.Reporter.GitHub.Pull.ID)
	assert.Equal(t, "reviewdog", toOpts.ConfigFlags.Reporter.GitHub.Owner)
	assert.Equal(t, "reviewdog", toOpts.ConfigFlags.Reporter.GitHub.Repo)
